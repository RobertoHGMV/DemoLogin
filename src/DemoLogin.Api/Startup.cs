...
using DemoLogin.Infra.Repositories;
...
namespace DemoLogin.Api
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            Runtime.SecurityKey = Configuration[Runtime.Fieldsname.SecurityKey];
        ...
        {
            var key = Encoding.ASCII.GetBytes(Runtime.SecurityKey);
